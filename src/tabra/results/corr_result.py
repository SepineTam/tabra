...
class CorrResult(BaseResult):
    """Result object for correlation matrix computation."""
    ...
    @property
    def n_obs(self) -> int:
        """Number of observations used (pairwise complete)."""
        return self._n_obs
    ...
    def save(self, path: str = "corr_result.txt"):
